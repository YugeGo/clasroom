...
function getCurrentPeriodSlots(): string[] {
  ...
  // 午休: 11:50-14:00 → 全空闲
  if (total >= 11 * 60 + 50 && total < 14 * 60 + 0) return ["0102", "0304", "0506", "0708", "0910"];
  // 5-6节: 14:00-15:30
  ...
  // 晚饭: 17:20-18:40 → 全空闲
  if (total >= 17 * 60 + 20 && total < 18 * 60 + 40) return ["0102", "0304", "0506", "0708", "0910"];
  // 9-10节: 18:40-20:10
  if (total >= 18 * 60 + 40 && total < 20 * 60 + 10) return ["0910"];
  // 其余时段（深夜/清晨）：没课，全空闲
  return ["0102", "0304", "0506", "0708", "0910"];
}
